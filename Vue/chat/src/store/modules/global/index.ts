...
export const useGlobalStore = defineStore('global-store', {
    ...
    state: (): GlobalState => ({
        vipCenterDialog: false, // 会员中心
        feedbackDialog: false, // 提交反馈弹窗
    ...
    actions: {
        ...
        updateFeedbackDialog(back: boolean) {
            this.feedbackDialog = back
        },

        // 会员中心
        updateVipDialog(show: boolean) {
            this.vipCenterDialog = show
        },
        ...
        updateUserInfoDialog(payDialog: boolean, info: string = "") {
            this.userInfoDialog = payDialog
            this.userInfo = info
        },
        updateUserInfoTab(info: string = "") {
            this.userInfo = info
        },
