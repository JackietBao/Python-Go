...
<template>
  <RouterLink :to="homePage" class="mr-20">
		<div class="flex justify-start items-center ">
			<img :src="logoPath ? logoPath : logo" :class="getMobileClass"  class="cursor-pointer px-0 dark:border-[#ffffff17] border-#ebebeb-400" alt="">
			<h1 class="text-[26px] line-clamp-1 ml-0.5 capitalize leading-none w-auto pb-0 pt-1 min-w-[120px] ">{{sideName || "GoMaxAi"}}</h1>
		</div>
  </RouterLink>
</template>
