  ...
  <div class="pt-5">
    ...
    >
      ...
      <NFormItem path="password">
        <NInput v-model:value="registerForm.password" tabindex="2"  placeholder="请输入您的账户密码" type="password" :maxlength="30" show-password-on="click"  @keyup.enter="handlerSubmit" />
      </NFormItem>
      <NFormItem path="phone">
        <NInput v-model:value="registerForm.phone" tabindex="3" placeholder="请填写您的手机号" />
      </NFormItem>
    ...
    >
      <NFormItem path="phone">
        <NInput v-model:value="loginForm.phone" tabindex="1" placeholder="请输入手机号" />
      </NFormItem>
      <NFormItem path="password">
        <NInput v-model:value="loginForm.password"  placeholder="请输入您的账户密码" type="password" :maxlength="30" show-password-on="click" tabindex="2" @keyup.enter="handlerSubmit" />
      </NFormItem>
