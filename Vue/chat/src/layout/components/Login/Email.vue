  ...
  <div class="pt-5">
    ...
    >
      <NFormItem path="username">
        <NInput v-model:value="registerForm.username" tabindex="1" placeholder="请输入您的用户名昵称" />
      </NFormItem>
      <NFormItem path="password">
        <NInput v-model:value="registerForm.password" placeholder="请输入您的账户密码" type="password" :maxlength="30" show-password-on="click" tabindex="2" @keyup.enter="handlerSubmit" />
      </NFormItem>
      <NFormItem path="email">
        <NInput v-model:value="registerForm.email" tabindex="3" placeholder="请填写您的邮箱账号" />
      </NFormItem>
      <NFormItem path="captchaCode">
        <div class="flex items-center w-full space-x-4">
          <NInput v-model:value="registerForm.captchaCode" tabindex="4" class="flex-1" placeholder="请填写图中验证码结果" />
          <div v-if="captchaSvg">
      ...
      <NFormItem path="invitedBy">
        <NInput v-model:value="registerForm.invitedBy" tabindex="5" placeholder="邀请码[非必填]" />
      </NFormItem>
    ...
    >
      <NFormItem path="username">
        <NInput v-model:value="loginForm.username" tabindex="1" placeholder="请输入用户名/邮箱号" />
      </NFormItem>
      <NFormItem path="password">
        <NInput v-model:value="loginForm.password" tabindex="2" placeholder="请输入您的账户密码" type="password" :maxlength="30" show-password-on="click" @keyup.enter="handlerSubmit" />
      </NFormItem>
