...
<template>
  <div class="main bg-[#f8f8fb] min-h-screen bg-center dark:bg-[#1F1F38]">
    ...
    <div class="flex-1 flex-wrap py-5 flex justify-between" :class="[isMobile ? 'px-3' : 'px-20']">
      <div class="px-[12px] min-w-[350px]" :class="[isMobile ? 'w-full' : 'w-1/3']">
        ...
        <!-- 数据统计 -->
        <div class="flex flex-col bg-[#fff] mt-5 rounded dark:bg-[#313155]  px-2">
      ...
      <div class="px-[12px]" :class="[isMobile ? 'w-full' : 'w-2/3']">
        <!-- 推荐链接 -->
        <div class="bg-[#fff]  dark:bg-[#313155] p-5 rounded flex">
          <div class="w-full flex ">
            ...
            <div ref="selectable" class="bg-[#fafafa] dark:bg-[#2D2D4F] flex-1 flex items-center  dark:border-[#ffffff17] border-b border-t pl-4 max-w-[500px] select-text overflow-x-hidden whitespace-nowrap">
              {{ inviteUrl }}
            </div>
        ...
        <!-- 推荐记录 -->
        <div class="mt-5 bg-[#fff] p-5 dark:bg-[#313155]">
          <NTabs ref="tabRef"
								 v-model:value="tabValue"
								 :bar-width="338" animated
								 justify-content="space-evenly"
								 type="line"
								 @update:value="handleUpdateValue">
            <NTabPane name="rec" tab="推介记录">
              <div class="pt-5">
                <NDataTable :min-width="200"
														:loading="recLoading"
														:remote="true"
            ...
            <NTabPane name="drawMoney" tab="提现记录">
              <div class="pt-5">
                <NDataTable :loading="drawOrderLoading"
														:remote="true"
														pagination-behavior-on-filter="first"
														class="min-h-[350px]"
            ...
            <NTabPane name="register" tab="注册用户">
              <div class="pt-5">
                <NDataTable :loading="registerLoading"
														:remote="true"
														pagination-behavior-on-filter="first"
														class="min-h-[350px]"
														:columns="regColums"
