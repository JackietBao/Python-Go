...
<template>
  <div class="overflow-hidden pr-0 bg-[#E7ECF6]   h-full   dark:bg-[#18181c] flex flex-col">
    <div class="market overflow-y-auto flex-1 min-h-screen h-[80vh] p-2 bg-[#F7F7F7] dark:bg-[#131323]  relative ">
