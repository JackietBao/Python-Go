...
<template>
	<div class="start-mj w-full mt-2 rounded-3xl p-6 py-8 dark:bg-[#313155] bg-[#F7F7F7] flex-1 h-full">
		...
		<div class="body mt-4 h-full">
			<ul class="flex justify-between h-full min-h-[400px]">
              ...
              <li  v-for="_ in 5">
                  <div class="bg-[#F7F7F7] relative dark:bg-[#1F1F38] w-[14rem] rounded-3xl overflow-hidden  ">
                      <n-space vertical >
				...
				<li v-for="item in imageList" class="bg-[#F7F7F7] relative dark:bg-[#1F1F38] w-[14rem] h-[400px] rounded-3xl overflow-hidden mr-2 ml-2">
