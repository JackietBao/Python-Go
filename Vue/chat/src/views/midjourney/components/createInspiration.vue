...
<template>
	...
	>
		...
		<div class="flex justify-between">
			...
			<div class="w-2/12 h-full  flex flex-col">

				<div class="dark:bg-[#1C1C34] dark:border-gray-600 border bg-[#F7F7F7] h-[470px] rounded p-2">
					<p>{{ selectIncantation }}</p>
				</div>

				<div @click="handleGoPrompt" class="rounded-full flex items-center justify-center mt-2 w-full h-[42px] cursor-pointer dark:bg-gradient-to-r dark:from-[#3144F1] dark:to-[#01C0F9]  bg-gradient-to-r from-[#3144F1] to-[#01C0F9]">
