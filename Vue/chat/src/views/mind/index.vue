...
<template>
  <div class="flex grow flex-col sm:flex-row h-full">
    <div class="sm:pt-4 box-border bg-[#F7F7F7] h-[90%] dark:bg-[#131323] overflow-y-auto w-full sm:w-[20rem] shrink-0 border-r-2 border-[#ffffff17] flex flex-col ">
    ...
    <div class="h-full flex-1 overflow-y-auto overflow-hidden min-h-[80vh] flex flex-col">
			...
			<div class="flex-1 w-full p-4 ">
				<svg ref="svgRef" class="box-border  w-full h-[80vh] border dark:border-gray-600 rounded-md " />
			</div>
    </div>
  </div>
</template>
